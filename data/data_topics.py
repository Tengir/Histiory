...
3) Гостиница «Аманауз»
4) Гостиница «Тарелка»''',
               '''Что изобраджено на картинке? (20)
...
4) Давка на Ходынском поле (30 мая 1896 года)''',
               '''В каком году произошел Стрелецкий бунт? (40)
1) 1680
2) 1681
3) 1682
4) 1684'''],
...
information = [[[
    ...
    [
        '''Композитор - Матвей Блантер, автор слов - Михаил Исаковский. В селе Всходы Угранского района (недалеко от  деревни Глотовка - родины М. Исаковского), в Доме культуры, расположен музей песни «Катюша».''',
        '''Песня композитора Яна Френкеля на стихи Расула  Гамзатова в переводе на русский язык Наума  Гребнева. Песня посвящена солдатам, погибшим  во время военных действий.''',
        '''Советская пенся, написанная Анатолием Новиковым на стихи Льва Ошанина вскоре после окончания Великой Отечественной войны, осенью 1945 года, для театрализованной программы "Весна победная", которую задумал и осуществил к празднику 7 ноября режиссёр Ансамбля песни и пляски войск НКВД Сергей Юткевич.''',
        '''Песня из кинофильма «Небесный тихоход», поставленного в 1945 году  режиссёром Семёном Тимошенко. Песня встречается также под другими заглавиями: "Пилоты", "Перелетные птицы", "Потому что мы пилоты" и т. д. и звучит как клятвы героев в момент, когда друзья приходят проведать  сослуживца в госпитале. В фильме песню исполняют  Николай Крючков и Василий Меркурьев.'''
    ],
    [
    ...
    [
        ...
        '''Стрелецкий бунт - это восстание стрельцов, пехотных войск в Российской империи в 1698 году. Бунт произошел во время царствования Петра I, который предпринимал ряд реформ для модернизации и укрепления армии и государства. Одной из главных причин бунта было несогласие стрельцов с реформами, проводимыми Петром I, в том числе с введением новых военных формирований и образованием регулярной армии на западном образце. Кровопролитные столкновения произошли в Москве в течение нескольких дней. В результате уличных боев, артиллерийской атаки и огня из Кремлевской пушки стрельцы были разгромлены, а их лидеры были казнены или сосланы. Бунт стал сигналом Петру I о необходимости проводить дальнейшие реформы и укреплять свою власть.'''
    ],
    [
    ],
    [
...
topics = [Topic(topic, [SubTopic(stn, [Question(f"Вопрос{j} {k}", "1", 3) for k in range(4)])
